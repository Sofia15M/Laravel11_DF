        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form method="POST" action="{{ route('vigilantes.update', $vigilante->ID_Vigilante) }}" class="max-w-sm mx-auto">
                    ...
                    <div class="mb-5">
                        <label for="Foto_Vigilante" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto Actual</label>
                        <img src="{{ asset('storage/' . $vigilante->Foto_Vigilante) }}" alt="Foto del Vigilante" class="w-50">
                    </div>

                    <!-- Área para capturar nueva imagen con la cámara -->
                    <div class="mb-5">
                        <label for="Foto_Vigilante" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nueva Foto (opcional)</label>
                        <div class="mb-4">
