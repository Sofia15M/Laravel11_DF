                                ...
                                @if (auth()->user()->id_rol == 1)
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex justify-center">
                                            ...
                                            <button type="button" onclick="confirmDeactivate('{{ $apartamento->ID_Apartamento }}')" class="bg-naranja dark:bg-naranja1 hover:bg-naranja1 dark:hover:bg-naranja text-white font-bold py-2 px-4 rounded mr-2" title="Desactivar">
        ...
        function confirmDeactivate(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`{{ route('apartamento.index', ':id') }}`.replace(':id', id), {
                        method: 'POST',
                        headers: {
