        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-12">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8 ">
                ...
                <form method="POST" action="{{ route('apartamentos.store') }}" class="max-w-sm mx-auto">
                    ...
                    <button type="submit" class="text-white bg-Azul3 hover:bg-Otro focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-Otro dark:hover:bg-Azul3 dark:focus:ring-blue-800">Guardar</button>
